...
func main() {
	...
	targetEMA2 := fmt.Sprintf("/plotly-2ema?symbol=%s&maLengthLF=%d&maLengthHF=%d", tradingSymbols[0], defs.EMA2LengthDefaultLF, defs.EMA2LengthDefaultHF)
	...
	targetMA2 := fmt.Sprintf("/plotly-2ma?symbol=%s&maLengthLF=%d&maLengthHF=%d", tradingSymbols[0], defs.MA2LengthDefaultLF, defs.MA2LengthDefaultHF)
